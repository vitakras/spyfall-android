 ...
 */
public class LocationRecycleAdapter extends RecyclerView.Adapter<LocationRecycleAdapter.LocationViewHolder> {
    ...
    public LocationRecycleAdapter(Context context, List<Location> locationList) {
