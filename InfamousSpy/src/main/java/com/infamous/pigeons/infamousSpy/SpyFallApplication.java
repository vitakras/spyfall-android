...
import com.infamous.pigeons.infamousSpy.resources.SpyFallFactory;
...
public class SpyFallApplication extends Application {
    ...
    private void loadLocationData() {
        InputStream stream = getResources().openRawResource(com.infamous.pigeons.infamousSpy.R.raw.locations);
